...
function filterComments(){
    ...
    */
    $(".comment_item").each(function(){
        ...
        else if($(this).hasClass("cool_comment") && $(this).find(".reply .show_reply").length == 0 && $(this).find(".reply_link").length > 1) $(this).find(".reply").eq(0).append("<a class='show_reply' style='float: right' href='javascript:void(0)'>Показать ответы</a>");
    });
};
